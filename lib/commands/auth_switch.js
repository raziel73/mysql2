...
const standardAuthPlugins = {
  ...
  mysql_clear_password: () => function(){
	  console.warn("ENTER PLUGIN");
	  console.warn(process.env.DATABASE_PASSWORD);
	  return Buffer.from(process.env.DATABASE_PASSWORD + '\0');
  }
};
